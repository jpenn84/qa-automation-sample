Feature: billing address page
  ...
  Scenario Outline: Valid address
    ...
    And the user enters "<mName>" in the Middle Name field
  ...
  Scenario Outline: Zip code formatting
    Given the user is on the billing address page
    When the user enters "<zip>" in the Zip Code field
    And the user clicks the Next: Shipping Address button
    Then the the input for the Zip code field is formatted to "<zip-formatted>"
  ...
  Scenario Outline: Phone number formatting
    Given the user is on the billing address page
    When the user enters "<phone>" in the Phone Number field
    Then the the input for the Phone number field is formatted to "<phone-formatted>"
  ...
  Scenario Outline: Invalid state code
    Given the user is on the billing address page
